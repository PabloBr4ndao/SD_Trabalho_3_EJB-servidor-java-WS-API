...
import com.sd.entities.Bebida;
import com.sd.entities.Pedido;
import com.sd.entities.PedidoBebida;
import com.sd.entities.PedidoComida;
import com.sd.entities.PedidoSobremesa;
import com.sd.entities.Sobremesa;
...
public class RestauranteImpl {
    ...
    // Método para o Painel Administrativo
    public java.util.Collection<Object> listarTodosPedidos() {
        return (java.util.Collection) this.pedidos.values();
    }
}